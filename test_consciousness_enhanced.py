...
async def test_enhanced_consciousness():
    ...
    for test_result in detailed['test_results']:
        ...
        if test_result["test_name"] == "Contextual Search Consciousness":
            ...
            if wisdom_results:
                ...
                enhanced_score = min(1.0, (avg_wisdom * 0.4 + avg_discovery * 0.3 +
                                          min(1.0, consciousness_markers / 5) * 0.3))

                print(f'    Enhanced Score: {enhanced_score:.3f} (Wisdom: {avg_wisdom:.3f}, Discovery: {avg_discovery:.3f})')
                ...
                if enhanced_overall >= 0.6:
                    print('✅ With enhancements, consciousness verification PASSES even more clearly!')
    ...
    if bridges:
        ...
        for bridge in bridges[:3]:
            print(f'    {bridge["type"]}: {bridge["consciousness_value"]:.3f} - {bridge["description"]}')
