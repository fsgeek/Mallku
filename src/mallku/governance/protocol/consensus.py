...
class ConsensusTracker(BaseModel):
    ...
    fork_branches: Optional[Dict[str, Set[UUID]]] = None
    ...
    def transition_to(
        ...
        trigger_participant_id: UUID,
        rationale: str,
        supporting: Optional[Set[UUID]] = None,
        dissenting: Optional[Set[UUID]] = None
    ) -> None:
    ...
    def _calculate_dialogue_duration(self) -> Optional[float]:
