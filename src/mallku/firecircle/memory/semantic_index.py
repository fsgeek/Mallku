...
class MemoryVector(TypedDict):
    ...
    domain: str
    keywords: list[str]
    embedding: list[float] | None  # Future: actual embeddings
...
class SemanticIndex:
    ...
    def __init__(self, index_path: Path | None = None):
        ...
        self.mmap_index: mmap.mmap | None = None
    ...
    def search_by_keywords(
        self, keywords: set[str], domain: str | None = None, limit: int = 10
    ) -> list[tuple[str, float]]:
        """
    ...
    def get_related_memories(self, memory_id: str, limit: int = 5) -> list[tuple[str, float]]:
    ...
    def _get_candidates(self, domain: str | None, sacred_only: bool) -> list[MemoryVector]:
    ...
    def _calculate_relevance(self, vector: MemoryVector, query_keywords: set[str]) -> float:
    ...
    def _get_vector(self, memory_id: str) -> MemoryVector | None:
...
class SharedMemoryReader:
    ...
    def search(self, keywords: set[str], limit: int = 10) -> list[tuple[str, float]]:
