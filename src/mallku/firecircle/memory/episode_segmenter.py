...
class EpisodeSegmenter:
    ...
    def __init__(self, criteria: SegmentationConfig | None = None):
    ...
    def process_round(
        self, round_summary: RoundSummary, session_context: dict[str, Any]
    ) -> EpisodicMemory | None:
        """
    ...
    def _create_episodic_memory(
        self, session_context: dict[str, Any], session_id: UUID
    ) -> EpisodicMemory:
    ...
    def _calculate_consciousness_indicators(self) -> ConsciousnessIndicator:
        ...
        for round_data in self.current_episode_data:
            ...
            surprise_scores.append(getattr(round_data, "surprise_score", 0.0))
            wisdom_scores.append(round_data.consciousness_score)
            coherence_scores.append(getattr(round_data, "coherence_score", 0.5))
    ...
    def _assess_transformation_potential(self) -> float:
        ...
        peak_consciousness = max(
            (r.consciousness_score for r in self.current_episode_data), default=0.0
        )
