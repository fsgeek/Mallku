...
def demonstrate_cosmetic_transformation():
    ...
    coherence = recognizer.sense_coherence(
        before_state=before, after_state=after, claimed_change="Removed domination language"
    )
...
def demonstrate_graceful_transformation():
    ...
    # Sense the coherence
    coherence = recognizer.sense_coherence(
        before_state=before, after_state=after, claimed_change="Transform to reciprocal pattern"
    )
