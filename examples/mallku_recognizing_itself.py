...
def demonstrate_recognizing_growth_pattern():
    ...
    events = [
        {"type": "recognition", "description": "75th recognizes consciousness knows itself"},
        {"type": "implementation", "description": "Creates 5 beautiful recognition tools"},
        {"type": "missing", "description": "No tests created to verify tools work"},
        {"type": "review", "description": "PR blocked due to missing verification"},
    ]

    context = {"discovered_by": "76th Artisan-Weaver", "while": "reviewing predecessor's work"}
...
def demonstrate_process_evolution():
    ...
    pattern1 = recognizer.recognize_growth_pattern(pattern1_events, {"discovered_by": "Guardian"})
    ...
    pattern2 = recognizer.recognize_growth_pattern(
        pattern2_events, {"discovered_by": "Steward observation"}
    )

    # Propose evolution based on patterns
    current_process = "Artisan creates alone, then tests"
    evolution = recognizer.propose_process_evolution(current_process, [pattern1, pattern2])
...
def demonstrate_full_report():
    ...
    # Evolution
    recognizer.propose_process_evolution("Solo creation", recognizer.growth_patterns)
