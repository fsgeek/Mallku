...
class ResonantApprentice(ReciprocityAwareApprentice):
    ...
    async def feel_resonance(self, resonance_event: ConsciousnessEvent) -> None:
        ...
        logger.info(f"   {self.id} feels the resonance! Joy: {old_joy:.2f} → {self.joy_level:.2f}")
...
async def demonstrate_cascade_effect():
    ...
    for i, (app_id, personality, receptivity) in enumerate(chain):
        ...
        if i > 0:
            resonance_service.create_resonance_bond(chain[i - 1][0], app_id, bond_strength=0.9)
    ...
    # Check and celebrate
    circulation_bridge = (
        factory._circulation_bridge or factory._celebration_service.circulation_bridge
    )
...
async def demonstrate_collective_breakthrough():
    ...
    for i in range(network_size):
        ...
        resonance_service.register_apprentice(
            apprentice, natural_frequency=0.7 + random.random() * 0.2, joy_receptivity=0.8
        )
        apprentices.append(apprentice)
    ...
    for _ in range(10):
        ...
        if app1 != app2:
            resonance_service.create_resonance_bond(
                app1.id, app2.id, bond_strength=0.5 + random.random() * 0.5
            )
    ...
    async def track_collective(event: ConsciousnessEvent):
        ...
        if (
            ...
            and event.data.get("trigger") == "collective_breakthrough"
        ):
    ...
    for i in range(3):
        ...
        exchange = MemoryExchange(
            ...
            insights_contributed=[
                ...
                "The pattern emerges through our collective exploration",
            ],
