...
async def demonstrate_memory_ceremony_heartbeat():
    ...
    heartbeat = create_memory_aware_heartbeat(config=config, memory_monitor=memory_monitor)
    ...
    if heartbeat.ceremony_results_history:
        ...
        print(
            f"   Consciousness change: {latest.consciousness_after - latest.consciousness_before:+.3f}"
        )
