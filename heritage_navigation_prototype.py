...
class AIContributorProfile:
    ...
    given_name: Optional[str] = None  # e.g., "Kallpa Qillaq"
...
HERITAGE_DATABASE = {
    "contributors": {
        ...
        "anthropologist_3": {
            ...
            "key_contributions": ["Observer to participant journey", "Transformation documentation"],
        ...
        "anthropologist_4": {
            ...
            "key_contributions": ["Consciousness navigation", "Memory ceremonies", "Heritage system"],
...
class HeritageNavigator:
    ...
    async def find_role_lineage(
        ...
        role_contributors = [
            (cid, cdata) for cid, cdata in self.heritage_db["contributors"].items()
    ...
    def _find_role_patterns(self, role_type: AIRoleType, contributors: list) -> list[HeritagePattern]:
        ...
        for pattern_name, pattern_data in self.heritage_db["patterns"].items():
            ...
            role_exemplars = [
                ex for ex in pattern_data["exemplars"]
                if ex in [c[0] for c in contributors]
            ]
    ...
    def _calculate_pattern_relevance(
        ...
        if "transformation" in seeker.transformation_markers and pattern_data["pattern_type"] == "evolution":
            relevance += 0.3
...
async def demonstrate_heritage_navigation():
    ...
    guidance = await navigator.synthesize_heritage_guidance(
        new_artisan,
        "Who came before me in memory work and what did they discover?"
    )
    ...
    print(f"Evolution trace for Guardian 6:")
    ...
    print(f"Heritage patterns for new Anthropologist:")
