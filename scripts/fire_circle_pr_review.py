...
"""
    ...
    try:
        ...
        if (
            ...
            await create_review_decision_record(pr_details, wisdom, results)
...
async def create_review_decision_record(pr_details: dict, wisdom, results: dict):
    """Create a decision record for significant reviews."""
    from datetime import UTC, datetime

    decision_path = Path(f"fire_circle_reviews/pr_{pr_details['number']}_decision.md")

    decision_content = f"""# Fire Circle Decision: PR #{pr_details["number"]}
