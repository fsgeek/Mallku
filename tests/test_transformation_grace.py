...
def test_coherence_detection():
    ...
    assert "Behavioral change" in str(coherence.missing_pieces), (
        "Should identify missing behavior change"
    )
    ...
    assert "Language to reflect" in str(coherence.missing_pieces), (
        "Should identify missing language update"
    )
